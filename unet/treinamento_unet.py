# -*- coding: utf-8 -*-
"""Treinamento_UNET.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_PtzG_ikrswoq72J2CMuUzRS8XrTCYAV
"""

# https://www.kaggle.com/eduardomineo/u-net-lung-segmentation-montgomery-shenzhen

!unzip '/content/drive/MyDrive/Mask_lung/ChinaSet_AllFiles.zip'
!unzip '/content/drive/MyDrive/Mask_lung/NLM-MontgomeryCXRSet.zip'
!unzip '/content/drive/MyDrive/Mask_lung/archive .zip'
!mkdir /content/input
...
INPUT_DIR = os.path.join("/","content", "input")
...
SEGMENTATION_DILATE_DIR = '/content/input/segmentation/train/dilate'
...
montgomery_left_mask_dir = glob(os.path.join('/content/MontgomerySet/ManualMask/leftMask', '*.png'))
...
for left_image_file in tqdm(montgomery_left_mask_dir):
    ...
    image_file = os.path.join('/content/MontgomerySet/CXR_png', base_file)
    right_image_file = os.path.join('/content/MontgomerySet/ManualMask/rightMask', base_file)
...
shenzhen_mask_dir = glob(os.path.join('/content/mask', '*.png'))
...
for mask_file in tqdm(shenzhen_mask_dir):
    ...
    image_file = os.path.join('/content/ChinaSet_AllFiles/CXR_png', base_file)
...
image = cv2.imread("/content/input/segmentation/test/CHNCXR_0053_0.png")
predict_image = cv2.imread("/content/input/segmentation/test/CHNCXR_0053_0_predict.png")
mask_image = cv2.imread("/content/input/segmentation/test/CHNCXR_0053_0_dilate.png")
...
image = cv2.imread("/content/input/segmentation/test/CHNCXR_0061_0.png")
predict_image = cv2.imread("/content/input/segmentation/test/CHNCXR_0061_0_predict.png")
mask_image = cv2.imread("/content/input/segmentation/test/CHNCXR_0061_0_dilate.png")
...
image = cv2.imread("/content/input/segmentation/test/CHNCXR_0067_0.png")
predict_image = cv2.imread("/content/input/segmentation/test/CHNCXR_0067_0_predict.png")
mask_image = cv2.imread("/content/input/segmentation/test/CHNCXR_0067_0_dilate.png")
...
image = cv2.imread("/content/input/segmentation/test/MCUCXR_0091_0.png")
predict_image = cv2.imread("/content/input/segmentation/test/MCUCXR_0091_0_predict.png")
mask_image = cv2.imread("/content/input/segmentation/test/MCUCXR_0091_0_dilate.png")
